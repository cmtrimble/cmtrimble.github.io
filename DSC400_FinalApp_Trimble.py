...
nlp_md = spacy.load("/mount/src/cmtrimble.github.io/Predictive_App/en_core_web_md")
nlp_sm = spacy.load("/mount/src/cmtrimble.github.io/Predictive_App/en_core_web_sm")
